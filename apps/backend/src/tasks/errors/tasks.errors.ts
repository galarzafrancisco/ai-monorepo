...
export const TasksErrorCodes = {
  ...
  INPUT_REQUEST_SELF: ErrorCodes.INPUT_REQUEST_SELF,
} as const;
...
export class InputRequestSelfError extends TasksDomainError {
  constructor(askedByActorId: string) {
    super(
      'Input request cannot be assigned to the asking actor.',
      TasksErrorCodes.INPUT_REQUEST_SELF,
      { askedByActorId },
    );
  }
}
