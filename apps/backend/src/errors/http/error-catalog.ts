...
> = {
  ...
  [ErrorCodes.INVALID_FLOW_STATE]: {
    status: 400,
    title: 'Invalid authorization flow state',
  ...
  [ErrorCodes.MISSING_REDIRECT_URI_OR_STATE]: {
    status: 400,
    title: 'Missing redirect URI or state',
    type: '/errors/authz/missing-redirect-or-state',
    retryable: false,
  },
  [ErrorCodes.CONNECTION_FLOW_NOT_FOUND]: {
    status: 404,
    title: 'Connection authorization flow not found',
  ...
  [ErrorCodes.INVALID_AUTHORIZATION_CODE]: {
    ...
    type: '/errors/authz/invalid-authorization-code',
    retryable: false,
  },
  [ErrorCodes.CLIENT_ID_MISMATCH]: {
    status: 401,
    title: 'Client ID mismatch',
    type: '/errors/authz/client-id-mismatch',
    retryable: false,
  },
  [ErrorCodes.AUTHORIZATION_CODE_USED]: {
    status: 401,
    title: 'Authorization code already used',
    type: '/errors/authz/authorization-code-used',
    retryable: false,
  },
  [ErrorCodes.AUTHORIZATION_CODE_EXPIRED]: {
    status: 401,
    title: 'Authorization code expired',
    type: '/errors/authz/authorization-code-expired',
    retryable: false,
  },
  [ErrorCodes.REDIRECT_URI_MISMATCH]: {
    status: 400,
    title: 'Redirect URI mismatch',
    type: '/errors/authz/redirect-uri-mismatch',
    retryable: false,
  },
  [ErrorCodes.PKCE_PARAMETERS_MISSING]: {
    status: 400,
    title: 'PKCE parameters missing',
    type: '/errors/authz/pkce-parameters-missing',
    retryable: false,
  },
  [ErrorCodes.INVALID_CODE_VERIFIER]: {
    status: 401,
    title: 'Invalid code verifier',
    type: '/errors/authz/invalid-code-verifier',
    retryable: false,
  },
  [ErrorCodes.TOKEN_REQUEST_PARAMETERS_MISSING]: {
    status: 400,
    title: 'Token request parameters missing',
    type: '/errors/authz/token-request-parameters-missing',
    retryable: false,
  },
